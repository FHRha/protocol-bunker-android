...
export const ru = {
  ...
  roleHost: "Создатель",
  roleControl: "Ведущий",
  roleHostControl: "Создатель и ведущий",
  rolePlayer: "Игрок",
  ...
  lobbyHostTransferTitle: "Передать ведущего",
  lobbyHostCurrent: (name: string) => `Текущий ведущий: ${name}`,
  lobbyHostTransferAuto: "Автовыбор (следующий онлайн)",
  lobbyHostTransferButton: "Передать ведущего",
  lobbyHostTransferNoCandidates: "Некому передавать: нет других онлайн-игроков.",
  hostMarker: " (создатель)",
  controlMarker: " (ведущий)",
  hostControlMarker: " (создатель, ведущий)",
  ...
  settingsDisaster: "Катастрофа",
  settingsDisasterRandom: "Случайная (по умолчанию)",
  settingsDisasterPlaceholder: "Выберите катастрофу",
  settingsDisasterRequiredHint: "Перед стартом выберите катастрофу.",
  settingsDisasterUnknown: "Не выбрана",
  settingsOn: "вкл",
  settingsOff: "выкл",
  ...
  hostChangedYou: "Вы стали ведущим комнаты.",
  hostChangedOther: (name: string) => `Новый ведущий: ${name}.`,
  ...
  votingSummarySelf: (name: string) => `Вы проголосовали против себя (${name}).`,
  votingSummaryNone: "Вы ещё не голосовали.",
  votingWeightNotice: (weight: number) => `Ваш голос в этом голосовании считается за ${weight}.`,
  voteCandidateTitle: "Карточки кандидата",
  voteCandidateHint: "Выберите игрока слева для просмотра раскрытых карт.",
  voteAgainstSelf: (name: string) => `Голос: против себя (${name})`,
  revoteBlockedSelected: "Этого игрока нельзя выбрать в переголосовании.",
  revoteBlockedTargets: (names: string) => `В переголосовании нельзя снова выбрать: ${names}.`,
